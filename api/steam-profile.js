...
export default async function handler(req, res) {
  ...
  try {
    ...
    const kills = getStat("total_kills"), deaths = getStat("total_deaths");
    ...
    const result = {
      ...
      profile_url: player.profileurl, steam_level: steamLevel,
      kills, deaths, kd, hs_percent: hsPercent,
      mvps: getStat("total_mvps"), wins: getStat("total_wins"),
      fav_weapon: favWeapon, hours, elo: 0, last_updated: Date.now(),
    };
